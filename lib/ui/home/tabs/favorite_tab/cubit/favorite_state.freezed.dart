...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl({required final List<Event> events}) : _events = events;
  ...
  @override
  String toString() {
    return 'FavoriteState.success(events: $events)';
  }
...
abstract class _Success implements FavoriteState {
  const factory _Success({required final List<Event> events}) = _$SuccessImpl;
